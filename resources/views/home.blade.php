                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4">
                        <div class="coverage-card">
                            ...
                            <h3>คุ้มครองครอบคลุมสำหรับทั้งครอบครัว</h3>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="coverage-card">
                            ...
                            <h3>ค่ารักษาพยาบาลสูงสุด 30,000 บาทต่ออุบัติเหตุ</h3>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="coverage-card">
                            ...
                            <h3>เงินชดเชยกรณีนอนโรงพยาบาลและห้อง ICU</h3>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="coverage-card">
                            ...
                            <h3>คุ้มครองทุกที่ที่คุณเดินทาง</h3>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="coverage-card">
                            ...
                            <h3>เครือข่ายโรงพยาบาลคู่สัญญาครอบคลุม</h3>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="coverage-card">
                            ...
                            <h3>ประสบการณ์กว่า 76 ปีที่คุณไว้วางใจได้</h3>
                        </div>
                    </div>
                </div>
            </div>
